<%@ page title="" language="C#" masterpagefile="~/CRM.master" autoeventwireup="true" inherits="CRM_CRMContacts, App_Web_1pla2zj3" %>
    ...
    <table id="tblCompMain" width="100%">
        <tr>
            <td>
                ...
                DataSourceID="CompaniesDS" AutoPostBack="True" 
                DataTextField="COMPANYNAME" DataValueField="COMPANIESID"  OnDataBound="ddlCompanies_DataBound">
                </asp:DropDownList>
            </td>
            <td align="right">
                <asp:LinkButton ID="btnAddContact" runat="server" Font-Size="Large" OnClick="btnAddContact_Click" ForeColor="blue">Add New Contact</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2">
                 <asp:ObjectDataSource ID="CompaniesDS" runat="server" TypeName="SandlerRepositories.CompaniesRepository" SelectMethod="GetCompaniesForDDL">
