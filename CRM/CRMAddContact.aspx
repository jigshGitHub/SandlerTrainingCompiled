<%@ page title="" language="C#" masterpagefile="~/CRM.master" autoeventwireup="true" inherits="CRM_CRMAddContact, App_Web_essflbce" %>
        ...
        <tr>
            <td style="width: 280px">
                <asp:DetailsView ID="dvContact" runat="server" Height="50px" Width="300px" AutoGenerateRows="False"
                    ...
                    OnItemInserted="dvContact_ItemInserted" 
                    OnModeChanging="dvContact_ModeChanging" ondatabound="dvContact_DataBound" 
                    ...
                    <Fields>
                        <asp:TemplateField HeaderText="Select Company:">
                            <InsertItemTemplate>
                                ...
                                DataTextField="COMPANYNAME" DataValueField="COMPANIESID"
                                SelectedValue='<%# Bind("COMPANIESID") %>'>
                                </asp:DropDownList>
                            </InsertItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Last Name :">
                            <InsertItemTemplate>
                                ...
                                <asp:RequiredFieldValidator ID="rfvLastNameTB" ControlToValidate="txtLastName"
                                    Display="Static" InitialValue="" runat="server" ErrorMessage="Please Enter Last Name to proceed.">
                                    *
                        ...
                        <asp:TemplateField HeaderText="E-mail :">
                            <InsertItemTemplate>
                                ...
                                <asp:RequiredFieldValidator ID="rfvEmailTB" ControlToValidate="txtEmail"
                                    Display="Static" InitialValue="" runat="server" ErrorMessage="Please Enter Email to proceed.">
                                    *
                                </asp:RequiredFieldValidator>
                            </InsertItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Action Step :">
                            <InsertItemTemplate>
                                ...
                                <asp:RequiredFieldValidator ID="rfvActStepTB" ControlToValidate="txtActStep"
